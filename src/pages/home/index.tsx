...
export default function HomePage() {
   ...
   useEffect(() => {
      const targetDate = new Date("2025-06-03T11:46:00");
                  ...
                  >
                     <AnimatePresence mode="wait">
                        <motion.span
                           ...
                           transition={{ duration: 0.3 }}
                        >
                           <b className="text-white">{marryTimeLeft.days}</b>{" "}
                           Gün,{" "}
                           <b className="text-white">{marryTimeLeft.hours}</b>{" "}
                           Saat,{" "}
                           <b className="text-white">{marryTimeLeft.minutes}</b>{" "}
                           Dakika,{" "}
                           <b className="text-white">{marryTimeLeft.seconds}</b>{" "}
                           Saniye
                        </motion.span>
                     </AnimatePresence>
                  </motion.p>
